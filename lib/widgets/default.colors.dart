...
class Defaults {
  ...
  static const MaterialColor primaryBleuColor =  MaterialColor(0xFF0f5169, <int, Color>{
    50: Color(0xFF0f5169),
  ...
  static const MaterialColor primaryGreenColor =  MaterialColor(0xFF14c9a6, <int, Color>{
    50: Color(0xFF14c9a6),
  ...
  static const Color drawerItemSelectedColor =bluePrincipal; //Colors.blue[700];
